...
# Load and prepare KPI source data -----------------------------------
    ...
    # kpi.3
        # kpi.3.1.c <- kpi.3.1(to.MmmYY)
        # kpi.3.1.p <- kpi.3.1(prev.to.MmmYY)
        # kpi.3.2.c <- kpi.3.2(to.MmmYY)
        # kpi.3.2.p <- kpi.3.2(prev.to.MmmYY)
...
#         kpi.6.2.c <- kpi.6.2(to.MmmYY)
#         kpi.6.2.p <- kpi.6.2(prev.to.MmmYY)
    # kpi.7
