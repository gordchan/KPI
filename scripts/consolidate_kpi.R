...
# Current Year
    ...
    kpi.3.1.c <- kpi.3.html("kpi.3.1", Dates[1,])
    kpi.3.2.c <- kpi.3.html("kpi.3.2", Dates[1,])
    kpi.3.3.c <- kpi.3.3.html(Dates[1,])
    kpi.3.4.c <- kpi.10(Dates[1,])	
    kpi.4.1.c <- kpi.4.1.html(Dates[1,])	
    kpi.4.2.c <- kpi.4.2.html(Dates[1,])	
    kpi.4.3.c <- kpi.4.3(Dates[1,])	
    kpi.5.1.c <- kpi.5.1.html(Dates[1,])	
...
# Previous Year	
    ...
    kpi.3.1.p <- kpi.3.html("kpi.3.1", Dates[3,])
    kpi.3.2.p <- kpi.3.html("kpi.3.2", Dates[3,])
    kpi.3.3.p <- kpi.3.3.html(Dates[3,])
    kpi.3.4.p <- kpi.10(Dates[3,])
    kpi.4.1.p <- kpi.4.1.html(Dates[3,])
    kpi.4.2.p <- kpi.4.2.html(Dates[3,])
    kpi.4.3.p <- kpi.4.3(Dates[3,])
    kpi.5.1.p <- kpi.5.1.html(Dates[3,])
...
# DS + SDS
    ...
    kpi.8.ovr <- kpi.8.html(Dates[1,], spec = "Overall", inst = "KWC")
    kpi.8.ovr.HA <- kpi.8.html(Dates[1,], spec = "Overall", inst = "HA")
    kpi.8.ent <- kpi.8.html(Dates[1,], spec = "ENT", inst = "KWC")
    kpi.8.ent.HA <- kpi.8.html(Dates[1,], spec = "ENT", inst = "HA")
    kpi.8.og <- kpi.8.html(Dates[1,], spec = "O&G", inst = "KWC")
    kpi.8.og.HA <- kpi.8.html(Dates[1,], spec = "O&G", inst = "HA")
    kpi.8.oph <- kpi.8.html(Dates[1,], spec = "OPH", inst = "KWC")
    kpi.8.oph.HA <- kpi.8.html(Dates[1,], spec = "OPH", inst = "HA")
    kpi.8.ort <- kpi.8.html(Dates[1,], spec = "ORT", inst = "KWC")
    kpi.8.ort.HA <- kpi.8.html(Dates[1,], spec = "ORT", inst = "HA")
    kpi.8.sur <- kpi.8.html(Dates[1,], spec = "SUR", inst = "KWC")
    kpi.8.sur.HA <- kpi.8.html(Dates[1,], spec = "SUR", inst = "HA")
